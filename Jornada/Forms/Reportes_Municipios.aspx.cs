...
public partial class Forms_Reportes_Municipios : System.Web.UI.Page
{
    ...
    protected void Soli_Grid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "reporte")
        {
            ...
            Reporte_ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reportes/Reporte_Municipios.rdlc");

            // CREAMOS DATATABLE PARA EL DETALLE
            DataTable dt_Sexo = Datosolicitud.Filtros("0", "0", "0", row.Cells[0].Text, "spr_Reportes_Sexo_M");
            DataTable dt_edades = Datosolicitud.Filtros("0", "0", "0", row.Cells[0].Text, "spr_Reportes_Edades_M");
            DataTable dt_Padron = Datosolicitud.Filtros("0", "0", "0", row.Cells[0].Text, "spr_Reportes_M");
    ...
    {
        dt = Datosolicitud.TraeJornadas("TotalJornadas_M");
